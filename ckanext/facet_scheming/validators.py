...
@scheming_validator
@validator
def facet_scheming_multiple_choice(field, schema):
    """
...
@validator
def facet_scheming_valid_json_object(value, context):
...
@scheming_validator
@validator
def facet_scheming_multiple_text(field, schema):
    """
...
@validator
def facet_scheming_valid_url(value: str) -> str:
    """
